...
from doctor.models import (Appointment, Doctor_Information, Prescription,
                           Prescription_medicine, Prescription_test, Report,
                           Specimen, Test, testCart, testOrder)
from hospital.models import Hospital_Information, Patient, User
from hospital_admin.models import (Test_Information, hospital_department,
                                   service, specialization)
from sslcommerz.models import Payment

# from django.contrib.auth.models import User
# from django.contrib.auth.forms import UserCreationForm
from .forms import CustomUserCreationForm, PasswordResetForm, PatientForm
from .models import Patient, User
from .utils import searchDepartmentDoctors, searchDoctors, searchHospitals
    ...
    if request.user.is_patient:
        ...
        if request.method == 'GET':
            ...
            try:    
                ...
                messages.error(request,'Profile updation failed, Enter correct values..')
